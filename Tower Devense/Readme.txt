...
-Each player earns every [X] secs og his [income] in "Gold".
...
-If an enemy is in range, the tower automaticly turns to the enemy and beginns shooting it, untill the enemy leaves the range or get gestroyd.
